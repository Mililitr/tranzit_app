...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(4) bool isAdmin,
      @HiveField(5) List<String> groups,
      @HiveField(6) DateTime? lastLoginDate});
}
...
class _$UserImpl implements _User {
  _$UserImpl(
      ...
      @HiveField(3) this.avatarUrl,
      @HiveField(4) this.isAdmin = false,
      @HiveField(5) final List<String> groups = const [],
      @HiveField(6) this.lastLoginDate})
      : _groups = groups;
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, avatarUrl: $avatarUrl, isAdmin: $isAdmin, groups: $groups, lastLoginDate: $lastLoginDate)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, avatarUrl,
      isAdmin, const DeepCollectionEquality().hash(_groups), lastLoginDate);
...
abstract class _User implements User {
  factory _User(
      ...
      @HiveField(4) final bool isAdmin,
      @HiveField(5) final List<String> groups,
      @HiveField(6) final DateTime? lastLoginDate}) = _$UserImpl;
